...
CREATE TABLE `book` (
  ...
  CONSTRAINT `fk_book_school_id` FOREIGN KEY (`school_id`) REFERENCES `school` (`school_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_book_user_id` FOREIGN KEY (`user_id`) REFERENCES `lib_user` (`user_id`) ON UPDATE CASCADE
...
CREATE TABLE `book_keywords` (
  ...
  CONSTRAINT `fk_book_keywords_book_id` FOREIGN KEY (`book_id`) REFERENCES `book` (`book_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
#
# TABLE STRUCTURE FOR: book_theme
#
...
CREATE TABLE `book_theme` (
  ...
  CONSTRAINT `fk_book_theme_book_id` FOREIGN KEY (`book_id`) REFERENCES `book` (`book_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `lib_user` (
  ...
  `user_pwd` int(10) unsigned NOT NULL,
  `user_name` varchar(45) NOT NULL,
  `school_id` int(10) unsigned NOT NULL,
  `last_update` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`user_id`),
  KEY `fk_user_school_id` (`school_id`),
  CONSTRAINT `fk_user_school_id` FOREIGN KEY (`school_id`) REFERENCES `school` (`school_id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `reservation` (
  ...
  CONSTRAINT `fk_reserv_school_id` FOREIGN KEY (`school_id`) REFERENCES `school` (`school_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_reserv_user_id` FOREIGN KEY (`user_id`) REFERENCES `lib_user` (`user_id`) ON UPDATE CASCADE
...
CREATE TABLE `review` (
  ...
  `user_id` int(10) unsigned NOT NULL,
  `book_id` int(10) unsigned NOT NULL,
  `rev_date` int(10) unsigned NOT NULL,
  `rating` enum('1','2','3','4','5') NOT NULL,
  PRIMARY KEY (`rev_id`,`user_id`,`book_id`),
  KEY `fk_review_user_id` (`user_id`),
  KEY `fk_review_book_id` (`book_id`),
  CONSTRAINT `fk_review_book_id` FOREIGN KEY (`book_id`) REFERENCES `book` (`book_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_review_user_id` FOREIGN KEY (`user_id`) REFERENCES `lib_user` (`user_id`) ON UPDATE CASCADE
...
CREATE TABLE `role` (
  ...
  CONSTRAINT `fk_role_user_id` FOREIGN KEY (`user_id`) REFERENCES `lib_user` (`user_id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `school` (`school_id`, `school_name`, `city`, `street`, `postal_code`, `email`, `principal_lastname`, `principal_firstname`, `school_admin_lastname`, `school_admin_firstname`, `last_update`) VALUES (1, 'Torphy, O\'Kon and White', 'East Sageborough', '389 Hansen Islands Suite 196', 61397, 'andy05@example.com', 'Bode', 'Nat', 'Reilly', 'Florencio', '1994-05-16 18:50:17');
INSERT INTO `school` (`school_id`, `school_name`, `city`, `street`, `postal_code`, `email`, `principal_lastname`, `principal_firstname`, `school_admin_lastname`, `school_admin_firstname`, `last_update`) VALUES (2, 'Reichel Ltd', 'Elissabury', '516 Erdman Well Apt. 429', 64553, 'olson.leopoldo@example.net', 'Berge', 'Pablo', 'Braun', 'Norene', '1971-08-03 17:17:53');
INSERT INTO `school` (`school_id`, `school_name`, `city`, `street`, `postal_code`, `email`, `principal_lastname`, `principal_firstname`, `school_admin_lastname`, `school_admin_firstname`, `last_update`) VALUES (3, 'Purdy, Effertz and Feest', 'New Freeda', '667 Schroeder Court Apt. 641', 28966, 'maggie.weissnat@example.com', 'Howe', 'Rylan', 'Wiegand', 'Terrance', '2022-04-23 15:57:39');
INSERT INTO `school` (`school_id`, `school_name`, `city`, `street`, `postal_code`, `email`, `principal_lastname`, `principal_firstname`, `school_admin_lastname`, `school_admin_firstname`, `last_update`) VALUES (4, 'Emard PLC', 'Rohanland', '9963 Hettinger Stravenue', 45567, 'amiya69@example.net', 'Langworth', 'Gideon', 'Schimmel', 'Leda', '2002-08-24 23:27:33');
INSERT INTO `school` (`school_id`, `school_name`, `city`, `street`, `postal_code`, `email`, `principal_lastname`, `principal_firstname`, `school_admin_lastname`, `school_admin_firstname`, `last_update`) VALUES (5, 'Borer, Blick and Jacobson', 'Hertashire', '654 Nikolaus Curve Suite 889', 70050, 'ssimonis@example.net', 'Kohler', 'Rachael', 'Davis', 'General', '2003-06-13 18:13:31');


#
# TABLE STRUCTURE FOR: school_phone
#
...
CREATE TABLE `school_phone` (
  ...
  CONSTRAINT `fk_school_id` FOREIGN KEY (`school_id`) REFERENCES `school` (`school_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
